...
public class RemoteConfiguration implements java.io.Serializable {
	...
	public RemoteConfiguration(boolean allowAttachments,
			boolean allowExternalUserManagment, boolean allowIssueLinking,
			boolean allowSubTasks, boolean allowTimeTracking,
			boolean allowUnassignedIssues, boolean allowVoting,
			boolean allowWatching, int timeTrackingDaysPerWeek,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = true
				...
				&& this.allowExternalUserManagment == other
	...
	public synchronized int hashCode() {
		...
		__hashCodeCalc = true;
		int _hashCode = 1;
		_hashCode += (isAllowAttachments() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isAllowExternalUserManagment()
				? Boolean.TRUE
				: Boolean.FALSE).hashCode();
		_hashCode += (isAllowIssueLinking() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isAllowSubTasks() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isAllowTimeTracking() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isAllowUnassignedIssues() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isAllowVoting() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
		_hashCode += (isAllowWatching() ? Boolean.TRUE : Boolean.FALSE)
				.hashCode();
	...
	static {
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("", "allowSubTasks"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "boolean"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		...
		elemField
				.setXmlName(new javax.xml.namespace.QName("", "allowWatching"));
		elemField.setXmlType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "boolean"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);

...
public class RemoteIssue
		extends
			com.atlassian.jira.rpc.soap.client.AbstractRemoteEntity
		implements
	...
	public RemoteIssue(
			...
			java.lang.String description, java.util.Calendar duedate,
			java.lang.String environment,
			com.atlassian.jira.rpc.soap.client.RemoteVersion[] fixVersions,
			java.lang.String key, java.lang.String priority,
			java.lang.String project, java.lang.String reporter,
			java.lang.String resolution, java.lang.String status,
			java.lang.String summary, java.lang.String type,
	 ...
	 */
	public void setAffectsVersions(
			com.atlassian.jira.rpc.soap.client.RemoteVersion[] affectsVersions) {
		this.affectsVersions = affectsVersions;
	}
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				&& ((this.affectsVersions == null && other.getAffectsVersions() == null) || (this.affectsVersions != null && java.util.Arrays
						.equals(this.affectsVersions,
								other.getAffectsVersions())))
				...
				&& ((this.attachmentNames == null && other.getAttachmentNames() == null) || (this.attachmentNames != null && java.util.Arrays
						.equals(this.attachmentNames,
								other.getAttachmentNames())))
				...
				&& ((this.created == null && other.getCreated() == null) || (this.created != null && this.created
						.equals(other.getCreated())))
				&& ((this.customFieldValues == null && other
						.getCustomFieldValues() == null) || (this.customFieldValues != null && java.util.Arrays
						.equals(this.customFieldValues,
								other.getCustomFieldValues())))
				&& ((this.description == null && other.getDescription() == null) || (this.description != null && this.description
						.equals(other.getDescription())))
				&& ((this.duedate == null && other.getDuedate() == null) || (this.duedate != null && this.duedate
				...
				&& ((this.updated == null && other.getUpdated() == null) || (this.updated != null && this.updated
	...
	public synchronized int hashCode() {
		...
		if (getAffectsVersions() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getAffectsVersions()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getAffectsVersions(), i);
		...
		if (getAttachmentNames() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getAttachmentNames()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getAttachmentNames(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
		...
		if (getCustomFieldValues() != null) {
			for (int i = 0; i < java.lang.reflect.Array
					.getLength(getCustomFieldValues()); i++) {
				java.lang.Object obj = java.lang.reflect.Array.get(
						getCustomFieldValues(), i);
				if (obj != null && !obj.getClass().isArray()) {
					_hashCode += obj.hashCode();
				}
			}
